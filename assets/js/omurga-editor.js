...
(function(){
  ...
  function blockTemplate(block){
    ...
    if(type === 'image') field = '<label><span>Görsel yolu veya URL</span><input data-block-value value="'+value+'" placeholder="uploads/gorsel.webp veya https://"></label><label><span>Alt metin / başlık</span><input data-block-caption value="'+caption+'" placeholder="Görsel açıklaması"></label>';
