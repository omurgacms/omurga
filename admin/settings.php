...
<p class="muted"><b><?=e(om_t('admin.profile_safe_change','Güvenli profil değişimi'))?>:</b> Profil değiştirildiğinde mevcut yazılar, sayfalar, kategoriler, medya dosyaları ve menüler silinmez. Sadece panel dili, varsayılan içerik tipi ve yeni bağlantı mantığı profile göre değişir.</p>
